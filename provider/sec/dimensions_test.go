	...
	Describe("BuildFundamental coverage", func() {
		It("references every FieldMappings entry", func() {
			...
			intermediate := map[string]bool{
				...
				"_proceedsInvestOther":                          true,
				"_absDividendsPaid":                             true,
				"_generalAndAdministrativeExpense":              true,
				"_sellingAndMarketingExpense":                   true,
				"_goodwill":                                     true,
				"_intangiblesExGoodwill":                        true,
				"_depreciation":                                 true,
				"_amortizationOfIntangibles":                    true,
				"_financeLeaseAmortization":                     true,
				"_paymentsRepurchaseCommon":                     true,
				...
				"_paymentsInvestOther":                          true,
				"_proceedsInvestShortTerm":                      true,
				"_proceedsInvestSaleAndMaturityOther":           true,
				"_liabilitiesNoncurrentRaw":                     true,
				"_ltDebtNoncurrentForLiab":                      true,
				"_opLeaseNoncurrentForLiab":                     true,
				"_finLeaseNoncurrentForLiab":                    true,
				"_otherLiabilitiesNoncurrentForLiab":            true,
				"_deferredRevenueNoncurrentForLiab":             true,
				"_accruedIncomeTaxesNoncurrentForLiab":          true,
				"_deferredTaxLiabilitiesNoncurrentForLiab":      true,
				"_proceedsShortTermDebt":                        true,
				...
				"_costsAndExpensesRaw":                          true,
				"_segmentReportingOtherItem":                    true,
				"_sgaBroad":                                     true,
				"_operatingIncomeFromFormula":                   true,
				"_operatingIncomeEbtFallback":                   true,
				"_cogsRaw":                                      true,
				"_insuranceBenefitsIncurred":                    true,
				"_insuranceClaimsPayable":                       true,
				"_minorityInterest":                             true,
				"_equityIncludingNCI":                           true,
				"_deferredTaxAssets":                            true,
				"_prepaidTaxAssets":                             true,
				...
				"_bdBankProvision":                              true,
				"_bdUnsecuredDebtProceeds":                      true,
				"_bdUnsecuredDebtRepayments":                    true,
				"_bdSecuredDebtProceeds":                        true,
				"_bdSecuredDebtRepayments":                      true,
				"_bdUnsecuredSTDebtNet":                         true,
				"_bdOtherSecuredSTDebtNet":                      true,
				"_bdDerivativeFinancing":                        true,
				"_bdProfessionalFees":                           true,
				"_capexGross":                                   true,
				...
				"_netOtherDebt":                                 true,
				"_cashStandard":                                 true,
				"_equityMethodInvestmentsForKoPattern":          true,
				"_financeLeaseROU":                              true,
				"_oilAndGasPropertyFullCost":                    true,
				"_otherIntangiblesAdditional":                   true,
				"_retailerDeferredTaxAndOtherNoncurrent":        true,
				"_operatingLeaseLiabilityCurrentRestaurant":     true,
				"_operatingLeaseLiabilityCurrentRetailer":       true,
				"_financeLeaseLiabilityCurrentRetailer":         true,
				"_operatingLeaseLiabilityCurrentFullCostEnergy": true,
				"_deferredTaxAndOtherNoncurrentCombined":        true,
				"_redeemableNCI":                                true,
				"_preOpeningCosts":                              true,
				"_restaurantImpairmentProvisions":               true,
				"_depreciationDepletionAndAmortization":         true,
				"_rentInCostOfRevenue":                          true,
				"_fcEnergyLeaseOperating":                       true,
				"_fcEnergyWorkover":                             true,
				"_fcEnergyProductionTax":                        true,
				"_fcEnergyAssetImpairment":                      true,
				"_fcEnergyARO":                                  true,
				"_fcEnergyDerivLiabNC":                          true,
				"_fcEnergyTemporaryEquity":                      true,
				"_fcEnergyInterestExpense":                      true,
				"_fcEnergyOtherProductiveAssets":                true,
				"_fcEnergyOilGasPropertyAcq":                    true,
				"_costOfRevenueDirect":                          true,
				"_otherOperatingIncomeExpenseNet":               true,
				"_retailerInterestNet":                          true,
				"_retailerInvestmentIncomeInterest":             true,
				"_capexEquipmentOnLease":                        true,
				"_proceedsDivestBusinesses":                     true,
				"_proceedsDivestBusinessesNetOfCashDivested":    true,
				"_proceedsIssuanceOrSaleOfEquity":               true,
				"_paymentsDebtIssuanceCosts":                    true,
				"_proceedsBusinessEquityMethod":                 true,
				"_proceedsInvestLeaseReceivables":               true,
				"_paymentsFinanceReceivables":                   true,
				"_proceedsCollectionFinanceReceivables":         true,
				"_proceedsSaleFinanceReceivables":               true,
			}
